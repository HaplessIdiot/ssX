static char rcsid[] = "$Header: /vol1/history/xf86/xc/extras/rman/rman.c,v 1.1 2000/03/21 00:47:34 dawes Exp $";
...
*/
		   ...
		   case 'v': /*case '?':*/
			printf("PolyglotMan v" POLYGLOTMANVERSION " of $Date: 2000/03/21 00:47:34 $\n");
			exit(0);
