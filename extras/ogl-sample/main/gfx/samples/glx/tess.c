...
**
** $Date: 2001/02/01 08:29:53 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/samples/glx/Attic/tess.c,v 1.1 2001/02/01 08:29:53 alanh Exp $
*/
#include <GL/glx.h>
#include <GL/glu.h>
#include <stdio.h>
