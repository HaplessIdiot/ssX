...
# $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/include/gl/template/Attic/glu.pl,v 1.1 2001/02/01 08:27:12 alanh Exp $
#
...
print "typedef void (*_GLUfuncptr)();\n";
print "\n";
