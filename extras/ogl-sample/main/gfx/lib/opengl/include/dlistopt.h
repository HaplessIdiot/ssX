...
**
** $Date: 2001/02/01 08:29:40 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/include/Attic/dlistopt.h,v 1.1 2001/02/01 08:29:40 alanh Exp $
*/
...
extern void GLAPIENTRY __gllc_InvalidValue(__GLcontext *gc);
extern void GLAPIENTRY __gllc_InvalidEnum(__GLcontext *gc);
extern void GLAPIENTRY __gllc_InvalidOperation(__GLcontext *gc);
extern void GLAPIENTRY __gllc_TableTooLarge(__GLcontext *gc);
extern void GLAPIENTRY __gllc_UnimplementedExtension(void);
extern void GLAPIENTRY __gllc_Error(__GLcontext *gc, GLenum error);
