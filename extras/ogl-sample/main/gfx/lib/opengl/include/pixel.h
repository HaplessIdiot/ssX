...
**
** $Date: 2001/02/01 08:29:43 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/include/Attic/pixel.h,v 1.1 2001/02/01 08:29:43 alanh Exp $
*/
#include "types.h"
#include "vertex.h"
#include "consts.h"
...
void GLAPIENTRY __gllei_ConvolutionFilter1D(__GLcontext *gc, GLenum target,
			GLenum internalformat, GLsizei width,
			GLenum format, GLenum type, const GLvoid *image);
void GLAPIENTRY __gllei_ConvolutionFilter2D(__GLcontext *gc, GLenum target,
			GLenum internalformat, GLsizei width, GLsizei height,
			GLenum format, GLenum type, const GLvoid *image);
void GLAPIENTRY __gllei_SeparableFilter2D(__GLcontext *gc, GLenum target,
			GLenum internalformat, GLsizei width, GLsizei height,
			GLenum format, GLenum type,
