...
void GLAPIENTRY __glim_ConvolutionFilter1D(GLenum target, GLenum internalFormat,
...
void GLAPIENTRY __gllei_ConvolutionFilter1D(__GLcontext *gc,
...
void GLAPIENTRY __glim_ConvolutionFilter2D(GLenum target, GLenum internalFormat,
				      GLsizei width, GLsizei height,
				      GLenum format, GLenum type,
				      const void* image)
{
...
void GLAPIENTRY __gllei_ConvolutionFilter2D(__GLcontext *gc,
			GLenum target, GLenum internalFormat,
			GLsizei width, GLsizei height,
			GLenum format, GLenum type,
			const void* image)
...
void GLAPIENTRY __glim_SeparableFilter2D(GLenum target, GLenum internalFormat,
				    GLsizei width, GLsizei height,
				    GLenum format, GLenum type,
...
void GLAPIENTRY __gllei_SeparableFilter2D(__GLcontext *gc,
			GLenum target, GLenum internalFormat,
			GLsizei width, GLsizei height,
			GLenum format, GLenum type,
			const void* row, const void* column)
...
void GLAPIENTRY __glim_CopyConvolutionFilter1D(GLenum target, GLenum internalFormat,
...
void GLAPIENTRY __glim_CopyConvolutionFilter2D(GLenum target, GLenum internalFormat,
					  GLint x, GLint y, GLsizei width,
					  GLsizei height)
{
    __GLconvolutionFilter *cf;
...
void GLAPIENTRY __glim_GetConvolutionFilter(GLenum target, GLenum format,
...
void GLAPIENTRY __glim_GetSeparableFilter(GLenum target, GLenum format, GLenum type,
...
void GLAPIENTRY __glim_ConvolutionParameteri(GLenum target, GLenum pname,
					GLint param)
{
    switch(pname) {
      case GL_CONVOLUTION_BORDER_MODE:
...
void GLAPIENTRY __glim_ConvolutionParameteriv(GLenum target, GLenum pname,
					 const GLint* params)
{
    switch(pname) {
      case GL_CONVOLUTION_BORDER_MODE:
...
void GLAPIENTRY __glim_ConvolutionParameterf(GLenum target, GLenum pname,
					GLfloat param)
{
    switch(pname) {
      case GL_CONVOLUTION_BORDER_MODE:
...
void GLAPIENTRY __glim_ConvolutionParameterfv(GLenum target, GLenum pname,
...
void GLAPIENTRY __glim_GetConvolutionParameteriv(GLenum target, GLenum pname,
					    GLint* params)
{
    GetConvolutionParameter(target, pname, params, GL_INT);
}

void GLAPIENTRY __glim_GetConvolutionParameterfv(GLenum target, GLenum pname,
					    GLfloat* params)
{
