...
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_varray.c,v 1.1 2001/02/01 08:29:34 alanh Exp $
*/
...
void GLAPIENTRY __glim_LockArraysEXT(GLint start, GLint count)
{
...
void GLAPIENTRY __glim_UnlockArraysEXT(void)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_InterleavedArrays(GLenum format, GLsizei stride, 
...
void __glInitVertexArrayState(__GLcontext *gc)
{
    ...
    gc->vertexArray.vp.proc = (void (GLAPIENTRY *)(const char *))__glGLAPIENTRYNop1;
    gc->vertexArray.np.size = 3;
    gc->vertexArray.np.type = GL_FLOAT;
    gc->vertexArray.np.proc = (void (GLAPIENTRY *)(const char *))__glGLAPIENTRYNop1;
    gc->vertexArray.cp.size = 4;
    gc->vertexArray.cp.type = GL_FLOAT;
    gc->vertexArray.cp.proc = (void (GLAPIENTRY *)(const char *))__glGLAPIENTRYNop1;
    gc->vertexArray.ip.size = 1;
    gc->vertexArray.ip.type = GL_FLOAT;
    gc->vertexArray.ip.proc = (void (GLAPIENTRY *)(const char *))__glGLAPIENTRYNop1;
    for (i=0; i<__GL_NUM_TEXTURE_UNITS; ++i) {
	gc->vertexArray.tp[i].size = 4;
	gc->vertexArray.tp[i].type = GL_FLOAT;
	gc->vertexArray.tp[i].proc = (void (GLAPIENTRY *)(const char *))__glGLAPIENTRYNop1;
    } 
    gc->vertexArray.ep.size = 1;
    gc->vertexArray.ep.type = GL_UNSIGNED_BYTE;
    gc->vertexArray.ep.proc = (void (GLAPIENTRY *)(const char *))__glGLAPIENTRYNop1;
...
void GLAPIENTRY __glim_ArrayElement(GLint i) 
{
    __GL_SETUP();
...
void GLAPIENTRY __glim_ArrayElementEXT(GLint i)
{
    __glim_ArrayElement(i);
}

void GLAPIENTRY __glim_DrawArrays(GLenum mode, GLint first, GLsizei count)
{
    GLuint lockBuffers;
...
void GLAPIENTRY __glim_DrawArraysEXT(GLenum mode,
				GLint first,
				GLsizei count)
{
...
void GLAPIENTRY __glim_DrawElements(GLenum mode, GLsizei count, GLenum type, 
...
void GLAPIENTRY __glim_DrawRangeElements(GLenum mode, GLuint start, GLuint end,
...
typedef struct {
    ...
    void (GLAPIENTRY *byte_funcs[5])(const GLbyte *);
    void (GLAPIENTRY *ubyte_funcs[5])(const GLubyte *);
    void (GLAPIENTRY *short_funcs[5])(const GLshort *);
    void (GLAPIENTRY *ushort_funcs[5])(const GLushort *);
    void (GLAPIENTRY *int_funcs[5])(const GLint *);
    void (GLAPIENTRY *uint_funcs[5])(const GLuint *);
    void (GLAPIENTRY *float_funcs[5])(const GLfloat *);
    /* skip over GL_2_BYTES...GL_4_BYTES */
    void (GLAPIENTRY *filler[3*5])(void);
    void (GLAPIENTRY *double_funcs[5])(const GLdouble *);
...
static void (GLAPIENTRY *(*vertex_func_table)[2][11][5])(const char *) = 
     (void (GLAPIENTRY *(*)[2][11][5])(const char *))(&vertex_funcs);
...
static void (GLAPIENTRY *(*normal_func_table)[2][11][5])(const char *) = 
     (void (GLAPIENTRY *(*)[2][11][5])(const char *))(&normal_funcs);
...
static void (GLAPIENTRY *(*color_func_table)[2][11][5])(const char *) = 
     (void (GLAPIENTRY *(*)[2][11][5])(const char *))(&color_funcs);     
...
static void (GLAPIENTRY *(*index_func_table)[2][11][5])(const char *) = 
     (void (GLAPIENTRY *(*)[2][11][5])(const char *))(&index_funcs);     
...
static void (GLAPIENTRY *(*tex_coord_func_table)[2][11][5])(const char *) = 
     (void (GLAPIENTRY *(*)[2][11][5])(const char *))(&tex_coord_funcs);     
...
void GLAPIENTRY __glim_VertexPointer(GLint size, GLenum type,
				GLsizei stride, const GLvoid *pointer)
{
    void (GLAPIENTRY *proc)(const char *);
    __GL_SETUP_NOT_IN_BEGIN();
    ...
    if (proc == (void (GLAPIENTRY *)(const char *))0x0) {
	__glSetError(GL_INVALID_ENUM);
	return;
    }
...
void GLAPIENTRY __glim_NormalPointer(GLenum type, GLsizei stride,
				const GLvoid *pointer)
{
    void (GLAPIENTRY *proc)(const char *);
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_ColorPointer(GLint size, GLenum type,
			       GLsizei stride, const GLvoid *pointer)
{
    void (GLAPIENTRY *proc)(const char *);
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_IndexPointer(GLenum type, GLsizei stride,
			       const GLvoid *pointer)
{
    void (GLAPIENTRY *proc)(const char *);
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_TexCoordPointer(GLint size, GLenum type,
				  GLsizei stride, const GLvoid *pointer)
{
    void (GLAPIENTRY *proc)(const char *);
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_EdgeFlagPointer(GLint stride, const GLboolean *pointer)
{
    __GL_SETUP_NOT_IN_BEGIN();
    ...
    gc->vertexArray.ep.proc = (void (GLAPIENTRY *)(const char *))glEdgeFlagv;
...
void GLAPIENTRY __gllc_ArrayElement(GLint i) 
{
    __glim_ArrayElement(i);
}

void GLAPIENTRY __gllc_ArrayElementEXT(GLint i)
{
    __glim_ArrayElement(i);
}

void GLAPIENTRY __gllc_DrawArrays(GLenum mode, GLint first, GLsizei count)
{
    GLint index;
    int i;
...
void GLAPIENTRY __gllc_DrawArraysEXT(GLenum mode, GLint first, GLsizei count)
{
    __gllc_DrawArrays(mode, first, count);
}

void GLAPIENTRY __gllc_DrawElements(GLenum mode, GLsizei count, GLenum type, 
			       const GLvoid *indices)
{
    GLint index;
    GLuint *elements;
...
void GLAPIENTRY __gllc_DrawRangeElements(GLenum mode, GLuint start, GLuint end,
				    GLsizei count, GLenum type, 
				    const GLvoid *indices)
{
    __GL_SETUP_NOT_IN_BEGIN_VALIDATE();
...
void GLAPIENTRY __glim_VertexPointerEXT(GLint size, GLenum type, GLsizei stride,
...
void GLAPIENTRY __glim_NormalPointerEXT(GLenum type, GLsizei stride,
				   GLsizei count, const GLvoid *pointer)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_ColorPointerEXT(GLint size, GLenum type, GLsizei stride,
				  GLsizei count, const GLvoid *pointer)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_IndexPointerEXT(GLenum type, GLsizei stride,
				  GLsizei count, const GLvoid *pointer)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_TexCoordPointerEXT(GLint size, GLenum type, 
...
void GLAPIENTRY __glim_EdgeFlagPointerEXT(GLsizei stride, GLsizei count, 
