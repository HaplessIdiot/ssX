...
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_eval.c,v 1.1 2001/02/01 08:29:05 alanh Exp $
*/
#include "context.h"
#include "global.h"
#include "attrib.h"
...
void GLAPIENTRY __glim_Map1d(GLenum type, GLdouble u1, GLdouble u2, 
...
void GLAPIENTRY __glim_Map1f(GLenum type, GLfloat u1, GLfloat u2, 
...
void GLAPIENTRY __glim_Map2d(GLenum type, 
...
void GLAPIENTRY __glim_Map2f(GLenum type, 
...
void GLAPIENTRY __glim_EvalCoord1d(GLdouble u)
{
    __GL_SETUP();
    __GL_API_EVAL();
    (*gc->procs.ec1)(gc, u);
...
void GLAPIENTRY __glim_EvalCoord1dv(const GLdouble u[1])
{
    __GL_SETUP();
    __GL_API_EVAL();
    (*gc->procs.ec1)(gc, u[0]);
...
void GLAPIENTRY __glim_EvalCoord1f(GLfloat u)
{
    __GL_SETUP();
    __GL_API_EVAL();
    (*gc->procs.ec1)(gc, u);
...
void GLAPIENTRY __glim_EvalCoord1fv(const GLfloat u[1])
{
    __GL_SETUP();
    __GL_API_EVAL();
    (*gc->procs.ec1)(gc, u[0]);
...
void GLAPIENTRY __glim_EvalCoord2d(GLdouble u, GLdouble v)
{
    __GL_SETUP();
    __GL_API_EVAL();
    (*gc->procs.ec2)(gc, u, v);
...
void GLAPIENTRY __glim_EvalCoord2dv(const GLdouble u[2])
{
    __GL_SETUP();
    __GL_API_EVAL();
...
void GLAPIENTRY __glim_EvalCoord2f(GLfloat u, GLfloat v)
{
    __GL_SETUP();
    __GL_API_EVAL();
    (*gc->procs.ec2)(gc, u, v);
...
void GLAPIENTRY __glim_EvalCoord2fv(const GLfloat u[2])
{
    __GL_SETUP();
    __GL_API_EVAL();
    (*gc->procs.ec2)(gc, u[0], u[1]);
...
void GLAPIENTRY __glim_MapGrid1d(GLint nu, GLdouble u0, GLdouble u1)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_MapGrid1f(GLint nu, GLfloat u0, GLfloat u1)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_MapGrid2d(GLint nu, GLdouble u0, GLdouble u1,
...
void GLAPIENTRY __glim_MapGrid2f(GLint nu, GLfloat u0, GLfloat u1,
...
void GLAPIENTRY __glim_EvalMesh1(GLenum mode, GLint low, GLint high)
{
...
void GLAPIENTRY __glim_EvalPoint1(GLint i)
{
    __GLevaluatorGrid *u;
    __GLfloat du;
    __GL_SETUP();
...
void GLAPIENTRY __glim_EvalMesh2(GLenum mode, 
...
void GLAPIENTRY __glim_EvalPoint2(GLint i, GLint j)
{
    __GLevaluatorGrid *u;
    __GLevaluatorGrid *v;
    __GLfloat du;
