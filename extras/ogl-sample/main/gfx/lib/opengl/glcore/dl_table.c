...
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/dl_table.c,v 1.1 2001/02/01 08:28:41 alanh Exp $
*/
#include "context.h"
#include <GL/gl.h>
#include <stdio.h>
...
GLboolean GLAPIENTRY __glim_IsList(GLuint list)
{
...
GLuint GLAPIENTRY __glim_GenLists(GLsizei range)
{
    __GLdlistMachine *dlstate;
    __GLnamesArray *array;
    GLuint start;
...
void GLAPIENTRY __glim_ListBase(GLuint base)
{ 
...
void GLAPIENTRY __glim_DeleteLists(GLuint list, GLsizei range)
{
    __GLdlistMachine *dlstate;
    __GLnamesArray *array;
