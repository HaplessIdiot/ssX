...
**
** $Date: 2001/02/01 08:29:20 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_pgdraw.c,v 1.1 2001/02/01 08:29:20 alanh Exp $
*/
#include "render.h"
#include "context.h"
#include "global.h"
