...
**
** $Date: 2001/02/01 08:29:24 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_prim.c,v 1.1 2001/02/01 08:29:24 alanh Exp $
*/
#include "context.h"
#include "global.h"
#include "g_imfncs.h"
...
void GLAPIENTRY __glim_Begin(GLenum mode)
{
    __GL_SETUP();
    GLuint beginMode;
...
void GLAPIENTRY __glim_End(void)
{
    __GL_SETUP();
    GLuint beginMode;
...
void GLAPIENTRY __glGLAPIENTRYNop1(GLint a) {}
...
void GLAPIENTRY __glim_UnimplementedExtension(void) 
{
    __glSetError(GL_INVALID_OPERATION);
    return;
}
