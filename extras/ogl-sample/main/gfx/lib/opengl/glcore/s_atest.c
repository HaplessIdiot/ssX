...
**
** $Date: 2001/02/01 08:28:56 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_atest.c,v 1.1 2001/02/01 08:28:56 alanh Exp $
*/
#include "context.h"
#include "render.h"
