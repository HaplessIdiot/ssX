...
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/dl_list.c,v 1.1 2001/02/01 08:28:38 alanh Exp $
*/
#include "dlistint.h"
#include "dlistopt.h"
#include "namesint.h"
...
void GLAPIENTRY __glim_NewList(GLuint list, GLenum mode)
{
...
void GLAPIENTRY __glce_EndList(void)
{
    __GL_SETUP();
...
void GLAPIENTRY __glim_EndList(void)
{
    __GLdlistMachine *dlstate;
    __GLdlist *dlist;
...
void GLAPIENTRY __gllc_CallList(GLuint list)
{
    __GLdlistOp *dlop;
...
void GLAPIENTRY __glce_CallList(GLuint list)
{
#ifndef NEW_LISTS
...
void GLAPIENTRY __glce_CallLists(GLsizei n, GLenum type, const GLvoid *lists)
{
#ifndef NEW_LISTS
    __GLdispatchState compExecState = __gl_dispatch;
#endif
...
void GLAPIENTRY __glim_CallList(GLuint list)
{
    __GL_SETUP();
...
** display list prevention code.
*/
void GLAPIENTRY __gllc_CallLists(GLsizei n, GLenum type, const GLvoid *lists)
{
    __GLdlistOp *dlop;
    GLuint size;
    GLint arraySize;
...
void GLAPIENTRY __glim_CallLists(GLsizei n, GLenum type, const GLvoid *lists)
{
    __GL_SETUP();
...
void GLAPIENTRY __glce_DrawArraysEXT(GLenum mode, GLint first, GLsizei count)
{
#ifndef NEW_LISTS
    __GLdispatchState compExecState = __gl_dispatch;
#endif
...
void GLAPIENTRY __glce_DrawElements(GLenum mode, GLsizei count, GLenum type,
...
void GLAPIENTRY __glce_DrawRangeElements(GLenum mode, GLuint start, GLuint end,
...
void GLAPIENTRY __glce_ArrayElementEXT(GLint i)
{
#ifndef NEW_LISTS
    __GLdispatchState compExecState = __gl_dispatch;
#endif
