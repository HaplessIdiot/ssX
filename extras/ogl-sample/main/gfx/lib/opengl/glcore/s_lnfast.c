...
**
** $Date: 2001/02/01 08:29:13 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_lnfast.c,v 1.1 2001/02/01 08:29:13 alanh Exp $
*/
#include "render.h"
#include "context.h"
#include "global.h"
