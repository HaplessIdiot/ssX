...
**
** $Date: 2001/02/01 08:28:44 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/px_api.c,v 1.1 2001/02/01 08:28:44 alanh Exp $
*/
...
*/
void GLAPIENTRY __glim_PixelStoref(GLenum mode, GLfloat value)
{
    switch (mode) {
...
void GLAPIENTRY __glim_PixelStorei(GLenum mode, GLint value)
{
...
*/
void GLAPIENTRY __glim_PixelZoom(GLfloat xfactor, GLfloat yfactor)
{
    __GLpixelState *ps;
    GLfloat xtemp, ytemp;
    __GL_SETUP_NOT_IN_BEGIN();
...
*/
void GLAPIENTRY __glim_PixelTransferf(GLenum mode, GLfloat value)
{
    __GLpixelState *ps;
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_BLAND();
...
void GLAPIENTRY __glim_PixelTransferi( GLenum mode, GLint value)
{
...
*/
void GLAPIENTRY __glim_PixelMapfv(GLenum map, GLint mapSize,
...
void GLAPIENTRY __glim_PixelMapuiv(GLenum map, GLint mapSize,
			const GLuint values[])
{
    __GLpixelState *ps;
    __GLpixelMapHead *pMap;
...
void GLAPIENTRY __glim_PixelMapusv(GLenum map, GLint mapSize,
...
*/
void GLAPIENTRY __glim_ReadBuffer(GLenum mode)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_BLAND();
...
void GLAPIENTRY __glim_DrawPixels(GLsizei width, GLsizei height, GLenum format,
...
void GLAPIENTRY __glim_ReadPixels(GLint x, GLint y, GLsizei width, GLsizei height, 
...
void GLAPIENTRY __glim_CopyPixels(GLint x, GLint y, GLsizei width, GLsizei height,
		       GLenum type)
{
    GLenum format;
    GLuint beginMode;
