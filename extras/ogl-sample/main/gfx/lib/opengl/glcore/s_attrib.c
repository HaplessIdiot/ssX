...
**
** $Date: 2001/02/01 08:28:58 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_attrib.c,v 1.1 2001/02/01 08:28:58 alanh Exp $
*/
#include "context.h"
#include "global.h"
#include "g_imfncs.h"
...
void GLAPIENTRY __glim_AlphaFunc(GLenum af, GLfloat ref)
{
...
void GLAPIENTRY __glim_BlendColor(GLfloat r, GLfloat g, GLfloat b, GLfloat a)
{
...
void GLAPIENTRY __glim_BlendEquation(GLenum mode)
{
#if defined(__GL_SUPPORT_ARB_IMAGING_SUBSET)
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_BlendFunc(GLenum sf, GLenum df)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_ClearAccum(GLfloat r, GLfloat g, GLfloat b, GLfloat a)
{
    __GLfloat minusOne;
    __GLfloat one;
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_ClearColor(GLfloat r, GLfloat g, GLfloat b, GLfloat a)
{
    __GLfloat zero;
    __GLfloat one;
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_ClearDepth(GLdouble z)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_BLAND();
...
void GLAPIENTRY __glim_ClearIndex(GLfloat val)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_BLAND();
...
void GLAPIENTRY __glim_ClearStencil(GLint s)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_BLAND();
...
void GLAPIENTRY __glim_ColorMask(GLboolean r, GLboolean g, GLboolean b, GLboolean a)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_ColorMaterial(GLenum face, GLenum p)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_CullFace(GLenum cfm)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_DepthFunc(GLenum zf)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_DepthMask(GLboolean enabled)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_DrawBuffer(GLenum mode)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_Fogfv(GLenum p, const GLfloat pv[])
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_Fogf(GLenum p, GLfloat f)
{
...
void GLAPIENTRY __glim_Fogiv(GLenum p, const GLint pv[])
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_Fogi(GLenum p, GLint i)
{
    /* Accept only enumerants that correspond to single values */
    switch (p) {
      case GL_FOG_DENSITY:
...
void GLAPIENTRY __glim_FrontFace(GLenum dir)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_Hint(GLenum target, GLenum mode)
{
    __GLhintState *hs;
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_IndexMask(GLuint i)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_Lightfv(GLenum light, GLenum p, const GLfloat pv[])
{
...
void GLAPIENTRY __glim_Lightf(GLenum light, GLenum p, GLfloat f)
{
    /* Accept only enumerants that correspond to single values */
    switch (p) {
      case GL_SPOT_EXPONENT:
...
void GLAPIENTRY __glim_Lightiv(GLenum light, GLenum p, const GLint pv[])
{
    __GLlightSourceState *lss;
    __GLmatrix *m;
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_Lighti(GLenum light, GLenum p, GLint i)
{
    /* Accept only enumerants that correspond to single values */
    switch (p) {
      case GL_SPOT_EXPONENT:
...
void GLAPIENTRY __glim_LightModelfv(GLenum p, const GLfloat pv[])
{
...
void GLAPIENTRY __glim_LightModelf(GLenum p, GLfloat f)
{
    /* Accept only enumerants that correspond to single values */
    switch (p) {
      case GL_LIGHT_MODEL_LOCAL_VIEWER:
...
void GLAPIENTRY __glim_LightModeliv(GLenum p, const GLint pv[])
{
    __GLlightModelState *model;
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_LightModeli(GLenum p, GLint i)
{
    /* Accept only enumerants that correspond to single values */
    switch (p) {
      case GL_LIGHT_MODEL_LOCAL_VIEWER:
...
void GLAPIENTRY __glim_LineStipple(GLint factor, GLushort stipple)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_LineWidth(GLfloat width)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_LogicOp(GLenum op)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_Materialfv(GLenum face, GLenum p, const GLfloat pv[])
{
    GLenum error;
...
void GLAPIENTRY __glim_Materialf(GLenum face, GLenum p, GLfloat f)
{
    /* Accept only enumerants that correspond to single values */
    switch (p) {
      case GL_SHININESS:
...
void GLAPIENTRY __glim_Materialiv(GLenum face, GLenum p,
		       const GLint pv[])
{
    GLenum error;
    GLint frontChange = 0, backChange = 0;
...
void GLAPIENTRY __glim_Materiali(GLenum face, GLenum p, GLint i)
{
    /* Accept only enumerants that correspond to single values */
    switch (p) {
      case GL_SHININESS:
...
void GLAPIENTRY __glim_PointSize(GLfloat f)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_PolygonMode(GLenum face, GLenum mode)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_PolygonStipple(const GLubyte *mask)
{
    GLubyte *stipple;
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_ShadeModel(GLenum sm)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_StencilMask(GLuint sm)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_StencilFunc(GLenum func, GLint ref, GLuint mask)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_StencilOp(GLenum fail, GLenum depthFail, GLenum depthPass)
{
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_PushAttrib(GLuint mask)
{
    __GLattribute **spp;
    __GLattribute *sp;
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_PopAttrib(void)
{
    __GLattribute **spp;
    __GLattribute *sp;
    GLuint mask;
...
void GLAPIENTRY __glim_Enable(GLenum cap)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_Disable(GLenum cap)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
GLboolean GLAPIENTRY __glim_IsEnabled(GLenum cap)
{
    GLuint bit;
...
void GLAPIENTRY __glim_PolygonOffset(GLfloat factor, GLfloat units)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_PushClientAttrib(GLbitfield mask)
{
...
void GLAPIENTRY __glim_PopClientAttrib(void)
{
    __GLclientAttribute **spp;
    __GLclientAttribute *sp;
    GLuint mask;
...
void GLAPIENTRY __glim_EnableClientState(GLenum mode)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_DisableClientState(GLenum mode)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_CullParameterfvEXT(GLenum pname, GLfloat *params)
{
    __GLcoord *pEye;
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_CullParameterdvEXT(GLenum pname, GLdouble *params)
{
