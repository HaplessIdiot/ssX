...
**
** $Date: 2001/02/01 08:29:00 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_clear.c,v 1.1 2001/02/01 08:29:00 alanh Exp $
*/
#include "context.h"
#include "global.h"
#include "g_imfncs.h"

void GLAPIENTRY __glim_Clear(GLbitfield mask)
{
    __GL_SETUP();
    GLuint beginMode;
