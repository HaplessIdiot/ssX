...
**
** $Date: 2001/02/01 08:29:10 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_lcomp.c,v 1.1 2001/02/01 08:29:10 alanh Exp $
*/
...
void GLAPIENTRY __gllc_Bitmap(GLsizei width, GLsizei height,
...
void GLAPIENTRY __gllc_PolygonStipple(const GLubyte *mask)
{
    __GLdlistOp *dlop;
    __GL_SETUP();
    GLubyte *newbits;
...
void GLAPIENTRY __gllc_Map1f(GLenum target, 
...
void GLAPIENTRY __gllc_Map1d(GLenum target, 
...
void GLAPIENTRY __gllc_Map2f(GLenum target, 
			GLfloat u1, GLfloat u2,
...
void GLAPIENTRY __gllc_Map2d(GLenum target, 
			GLdouble u1, GLdouble u2,
			GLint ustride, GLint uorder, 
...
void GLAPIENTRY __gllc_DrawPixels(GLint width, GLint height, GLenum format, 
...
void GLAPIENTRY __gllc_TexImage1D(GLenum target, GLint level, 
...
void GLAPIENTRY __gllc_TexImage2D(GLenum target, GLint level, 
			     GLint internalformat,
...
extern void GLAPIENTRY __gllc_TexImage3D(GLenum target, GLint level,
...
void GLAPIENTRY __gllc_TexSubImage1D(GLenum target, GLint level,
...
void GLAPIENTRY __gllc_TexSubImage2D(GLenum target, GLint level,
...
void GLAPIENTRY __gllc_TexSubImage3D(GLenum target, GLint level,
...
void GLAPIENTRY __gllc_Disable(GLenum cap)
{
    __GLdlistOp *dlop;
...
void GLAPIENTRY __gllc_Enable(GLenum cap)
{
    __GLdlistOp *dlop;
...
void GLAPIENTRY __gllc_ColorTable(GLenum target, GLenum internalformat,
...
void GLAPIENTRY __gllc_ColorSubTable(GLenum target, GLsizei start,
...
void GLAPIENTRY __gllc_ConvolutionFilter1D(GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const GLvoid *image)
{
    GLenum adjustFormat= format;
    GLenum adjustType= type;
    __GLdlistOp *dlop;
...
void GLAPIENTRY __gllc_ConvolutionFilter2D(GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *image)
{
    GLenum adjustFormat= format;
    GLenum adjustType= type;
    __GLdlistOp *dlop;
...
void GLAPIENTRY __gllc_SeparableFilter2D(GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *row, const GLvoid *col)
{
    GLenum adjustFormat= format;
    GLenum adjustType= type;
    __GLdlistOp *dlop;
...
void GLAPIENTRY __gllc_Histogram(GLenum target, GLsizei width, GLenum internalformat, GLboolean sink)
{
    __GLdlistOp *dlop;
