...
**
** $Date: 2001/02/01 08:29:06 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_feed.c,v 1.1 2001/02/01 08:29:06 alanh Exp $
*/
#include "context.h"
#include "g_imfncs.h"
#include "global.h"

void GLAPIENTRY __glim_FeedbackBuffer(GLsizei bufferLength, GLenum type, GLfloat buffer[])
{
...
void GLAPIENTRY __glim_PassThrough(GLfloat element)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_BLAND();
