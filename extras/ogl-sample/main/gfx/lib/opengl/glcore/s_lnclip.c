...
**
** $Date: 2001/02/01 08:29:12 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_lnclip.c,v 1.1 2001/02/01 08:29:12 alanh Exp $
*/
#include "math.h"
#include "context.h"
#include "global.h"
