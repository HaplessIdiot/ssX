...
**
** $Date: 2001/02/01 08:29:03 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_ctable.c,v 1.1 2001/02/01 08:29:03 alanh Exp $
*/
#include "global.h"
#include "types.h"
#include "g_imports.h"
...
void GLAPIENTRY __glim_ColorTable(GLenum target,
		GLenum internalFormat, GLsizei width,
...
void GLAPIENTRY __glim_CopyColorTable(GLenum target, GLenum internalFormat,
...
void GLAPIENTRY __glim_ColorSubTable(GLenum target,
			GLsizei start, GLsizei count,
		        GLenum format, GLenum type, const void *table)
{
    __GLcolorTable *ct;
...
void GLAPIENTRY __glim_CopyColorSubTable(GLenum target, GLsizei start,
				    GLint x, GLint y, GLsizei width)
{
    __GLcolorTable *ct;
    GLboolean isProxy;
...
void GLAPIENTRY __glim_GetColorTable(GLenum target, GLenum format, GLenum type,
			        void *table)
{
    __GLcolorTable *ct;
    GLboolean isProxy;
...
void GLAPIENTRY __glim_ColorTableParameteriv(GLenum target, GLenum pname,
				        const GLint *params)
{
    __GLcolorTable *ct;
    GLboolean isProxy;
...
void GLAPIENTRY __glim_ColorTableParameterfv(GLenum target, GLenum pname,
...
void GLAPIENTRY __glim_GetColorTableParameteriv(GLenum target, GLenum pname,
					   GLint *params)
{
    __GLcolorTable *ct;
    GLboolean isProxy;
...
void GLAPIENTRY __glim_GetColorTableParameterfv(GLenum target, GLenum pname,
					   GLfloat *params)
{
    __GLcolorTable *ct;
    GLboolean isProxy;
