...
**
** $Date: 2001/02/01 08:29:17 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_napi.c,v 1.1 2001/02/01 08:29:17 alanh Exp $
*/
#include "context.h"
#include "global.h"
#include "g_imfncs.h"

void GLAPIENTRY __glim_Normal3d(GLdouble x, GLdouble y, GLdouble z)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Normal3dv(const GLdouble v[3])
{
    GLdouble x, y, z;
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Normal3f(GLfloat x, GLfloat y, GLfloat z)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Normal3fv(const GLfloat v[3])
{
    GLfloat x, y, z;
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Normal3b(GLbyte x, GLbyte y, GLbyte z)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Normal3bv(const GLbyte v[3])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Normal3s(GLshort x, GLshort y, GLshort z)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Normal3sv(const GLshort v[3])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Normal3i(GLint x, GLint y, GLint z)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Normal3iv(const GLint v[3])
{
    __GL_SETUP();
    __GL_API_VAPI();
