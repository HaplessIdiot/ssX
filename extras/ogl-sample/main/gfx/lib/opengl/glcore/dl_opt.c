...
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/dl_opt.c,v 1.1 2001/02/01 08:28:38 alanh Exp $
*/
#include <stdio.h>
#include "global.h"
#include "context.h"
...
*/
void GLAPIENTRY __gllc_Begin(GLenum mode)
{
    __GLdlistOp *dlop;
...
** in the display list.
*/
void GLAPIENTRY __gllc_InvalidValue(__GLcontext *gc)
{
    __GLdlistOp *dlop;
...
void GLAPIENTRY __gllc_InvalidEnum(__GLcontext *gc)
{
    __GLdlistOp *dlop;
...
void GLAPIENTRY __gllc_InvalidOperation(__GLcontext *gc)
{
    __GLdlistOp *dlop;
...
void GLAPIENTRY __gllc_TableTooLarge(__GLcontext *gc)
{
    __GLdlistOp *dlop;
    dlop = __glDlistAllocOp2(gc, 0);
    if (dlop == NULL) return;
...
** dispatch tables.
*/
void GLAPIENTRY __gllc_UnimplementedExtension(void)
{
    __GLdlistOp *dlop;
    __GL_SETUP();
    dlop = __glDlistAllocOp2(gc, 0);
...
void GLAPIENTRY __gllc_Error(__GLcontext *gc, GLenum error)
{
    switch(error) {
