...
**
** $Date: 2001/02/01 08:29:08 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_hist.c,v 1.1 2001/02/01 08:29:08 alanh Exp $
*/
#include "context.h"
#include "g_imports.h"
#include "global.h"
...
void GLAPIENTRY __glim_ResetHistogram(GLenum target)
{
    __GLhistogram *hg;
    GLboolean isProxy;
...
void GLAPIENTRY __glim_Histogram(GLenum target, GLsizei width, 
			    GLenum internalFormat, GLboolean sink)
{
    __GLhistogram *hg;
    GLboolean isProxy;
...
void GLAPIENTRY __glim_GetHistogram(GLenum target, GLboolean reset, GLenum format,
...
void GLAPIENTRY __glim_GetHistogramParameteriv(GLenum target, GLenum pname,
					  GLint *params)
{
    GetHistogramParameters(target, pname, params, GL_INT);
}

void GLAPIENTRY __glim_GetHistogramParameterfv(GLenum target, GLenum pname,
					  GLfloat *params)
{
...
*/
void GLAPIENTRY __glim_Minmax(GLenum target, GLenum internalFormat, GLboolean sink)
{
    __GLminmax *mm;
    GLenum rv;
...
void GLAPIENTRY __glim_ResetMinmax(GLenum target)
{
    __GLminmax *mm;
...
void GLAPIENTRY __glim_GetMinmax(GLenum target, GLboolean reset, GLenum format,
			    GLenum type, GLvoid *values)
{
    __GLminmax *mm;
    __GLpixelSpanInfo spanInfo;
...
void GLAPIENTRY __glim_GetMinmaxParameteriv(GLenum target, GLenum pname, 
				       GLint *values)
{
    GetMinmaxParameters(target, pname, values, GL_INT);
}

void GLAPIENTRY __glim_GetMinmaxParameterfv(GLenum target, GLenum pname, 
				       GLfloat *values)
{
