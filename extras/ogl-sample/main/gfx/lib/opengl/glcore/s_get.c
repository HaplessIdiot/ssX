...
**
** $Date: 2001/02/01 08:29:07 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_get.c,v 1.1 2001/02/01 08:29:07 alanh Exp $
*/
#include "global.h"
#include "context.h"
#include "g_imfncs.h"
...
void GLAPIENTRY __glim_GetTexEnvfv(GLenum target,
...
void GLAPIENTRY __glim_GetTexEnviv(GLenum target,
...
void GLAPIENTRY __glim_GetTexGenfv(GLenum coord, GLenum pname,
			      GLfloat v[])
{
...
void GLAPIENTRY __glim_GetTexGendv(GLenum coord, GLenum pname,
			      GLdouble v[])
{
    __GLtextureGenState* tcs;
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_GetTexGeniv(GLenum coord, GLenum pname,
			      GLint v[])
{
    __GLtextureGenState* tcs;
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_GetTexParameterfv(GLenum target,
				    GLenum pname, GLfloat v[])
{
...
void GLAPIENTRY __glim_GetTexParameteriv(GLenum target,
				    GLenum pname, GLint v[])
{
    __GLtextureParamState *pts;
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_GetTexLevelParameterfv(GLenum target, GLint level,
					 GLenum pname, GLfloat v[])
{
    __GLtexture *tex;
    __GLmipMapLevel *lp;
...
void GLAPIENTRY __glim_GetTexLevelParameteriv(GLenum target, GLint level,
					 GLenum pname, GLint v[])
{
    __GLtexture *tex;
    __GLmipMapLevel *lp;
...
void GLAPIENTRY __glim_GetClipPlane(GLenum plane, GLdouble eqn[4])
{
    GLint index;
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_GET();
...
void GLAPIENTRY __glim_GetTexImage(GLenum target, GLint level, GLenum format,
...
void GLAPIENTRY __glim_GetPolygonStipple(GLubyte *outImage)
{
    __GLpixelSpanInfo spanInfo;
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_GET();
...
void GLAPIENTRY __glim_GetLightfv(GLenum light, GLenum pname,
		       GLfloat result[])
{
    GLint index;
...
void GLAPIENTRY __glim_GetLightiv(GLenum light, GLenum pname,
			     GLint result[])
{
    GLint index;
    __GLlightSourceState *src;
...
void GLAPIENTRY __glim_GetMaterialfv(GLenum face, GLenum pname,
				GLfloat result[])
{
...
void GLAPIENTRY __glim_GetMaterialiv(GLenum face, GLenum pname,
				GLint result[])
{
    __GLmaterialState *mat;
    __GL_SETUP_NOT_IN_BEGIN();
...
void GLAPIENTRY __glim_GetMapfv(GLenum target, GLenum query, GLfloat buf[])
{
...
void GLAPIENTRY __glim_GetMapdv(GLenum target, GLenum query, GLdouble buf[])
{
    __GLevaluator1 *eval1;
    __GLevaluator2 *eval2;
    __GLfloat *eval1Data, *eval2Data;
...
void GLAPIENTRY __glim_GetMapiv(GLenum target, GLenum query, GLint buf[])
{
    __GLevaluator1 *eval1;
    __GLevaluator2 *eval2;
    __GLfloat *eval1Data, *eval2Data;
...
void GLAPIENTRY __glim_GetPixelMapfv(GLenum map, GLfloat buf[])
{
    GLint index;
    GLint limit;
    GLfloat *rp;
...
void GLAPIENTRY __glim_GetPixelMapuiv(GLenum map, GLuint buf[])
{
    GLint index;
    GLint limit;
    GLuint *rp;
...
void GLAPIENTRY __glim_GetPixelMapusv(GLenum map, GLushort buf[])
{
    GLint index;
    GLint limit;
    GLushort *rp;
...
void GLAPIENTRY __glim_GetDoublev(GLenum sq, GLdouble result[])
{
    DoGet(sq, result, __GL_FLOAT64, "glGetDoublev");
}

void GLAPIENTRY __glim_GetFloatv(GLenum sq, GLfloat result[])
{
    DoGet(sq, result, __GL_FLOAT32, "glGetFloatv");
}

void GLAPIENTRY __glim_GetIntegerv(GLenum sq, GLint result[])
{
    DoGet(sq, result, __GL_INT32, "glGetIntegerv");
}

void GLAPIENTRY __glim_GetBooleanv(GLenum sq, GLboolean result[])
{
...
*/
GLenum GLAPIENTRY __glim_GetError(void)
{
    GLint error;
...
*/
const GLubyte * GLAPIENTRY __glim_GetString(GLenum name)
{
    __GL_SETUP_NOT_IN_BEGIN2();
    __GL_API_GET();
...
void GLAPIENTRY __glim_GetPointerv(GLenum pname,
			      void **params)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_GET();
...
void GLAPIENTRY __glim_GetPointervEXT(GLenum pname,
				 void **params)
{
