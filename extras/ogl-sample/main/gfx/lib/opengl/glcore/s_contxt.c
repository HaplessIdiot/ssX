...
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_contxt.c,v 1.1 2001/02/01 08:29:01 alanh Exp $
*/
#include "render.h"
#include "context.h"
#include "global.h"
...
GLint GLAPIENTRY __glim_RenderMode(GLenum mode)
{
    GLint rv = 0;
