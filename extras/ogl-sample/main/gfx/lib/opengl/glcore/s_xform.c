...
**
** $Date: 2001/02/01 08:29:35 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_xform.c,v 1.1 2001/02/01 08:29:35 alanh Exp $
*/
#include "context.h"
#include "g_imports.h"
#include "global.h"
...
void GLAPIENTRY __glim_MatrixMode(GLenum mode)
{
...
void GLAPIENTRY __glim_LoadIdentity(void)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_LoadMatrixf(const GLfloat m[16])
{
    __GLmatrix m1;
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_LoadMatrixd(const GLdouble m[16])
{
    __GLmatrix m1;
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_MultMatrixf(const GLfloat m[16])
{
    __GLmatrix m1;
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_MultMatrixd(const GLdouble m[16])
{
    __GLmatrix m1;
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_Rotatef(GLfloat angle, GLfloat x, GLfloat y, GLfloat z)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_Rotated(GLdouble angle, GLdouble x, GLdouble y, GLdouble z)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_Scalef(GLfloat x, GLfloat y, GLfloat z)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_Scaled(GLdouble x, GLdouble y, GLdouble z)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_Translatef(GLfloat x, GLfloat y, GLfloat z)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_Translated(GLdouble x, GLdouble y, GLdouble z)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_PushMatrix(void)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_BLAND();
...
void GLAPIENTRY __glim_PopMatrix(void)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_Frustum(GLdouble left, GLdouble right,
...
void GLAPIENTRY __glim_Ortho(GLdouble left, GLdouble right, GLdouble bottom, 
...
void GLAPIENTRY __glim_Viewport(GLint x, GLint y, GLsizei width, GLsizei height)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_DepthRange(GLdouble zNear, GLdouble zFar)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_STATE();
...
void GLAPIENTRY __glim_Scissor(GLint x, GLint y, GLsizei width, GLsizei height)
{
...
void GLAPIENTRY __glim_ClipPlane(GLenum pi, const GLdouble pv[])
{
    __GLfloat p[4];
    __GLtransform *tr;
    __GL_SETUP_NOT_IN_BEGIN();
