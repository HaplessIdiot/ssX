...
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_select.c,v 1.1 2001/02/01 08:29:27 alanh Exp $
*/
#include "context.h"
#include "global.h"
#include "g_imports.h"
...
void GLAPIENTRY __glim_SelectBuffer(GLsizei bufferLength, GLuint buffer[])
{
...
void GLAPIENTRY __glim_InitNames(void)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_BLAND();
...
void GLAPIENTRY __glim_LoadName(GLuint name)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_BLAND();
...
void GLAPIENTRY __glim_PopName(void)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_BLAND();
...
void GLAPIENTRY __glim_PushName(GLuint name)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_BLAND();
