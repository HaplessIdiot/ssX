...
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_capi.c,v 1.1 2001/02/01 08:28:59 alanh Exp $
*/
#include "context.h"
#include "global.h"
#include "g_imfncs.h"

void GLAPIENTRY __glim_Color3ub(GLubyte r, GLubyte g, GLubyte b)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_FastColor3ub(GLubyte r, GLubyte g, GLubyte b)
{
    __GLpixelMachine *pm;
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color3ubv(const GLubyte v[3])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_FastColor3ubv(const GLubyte v[3])
{
    __GLpixelMachine *pm;
    GLubyte r, g, b;
    __GL_SETUP();
...
void GLAPIENTRY __glim_Color3b(GLbyte r, GLbyte g, GLbyte b)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color3bv(const GLbyte v[3])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color3d(GLdouble r, GLdouble g, GLdouble b)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color3dv(const GLdouble v[3])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color3f(GLfloat r, GLfloat g, GLfloat b)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color3fv(const GLfloat v[3])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color3i(GLint r, GLint g, GLint b)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color3iv(const GLint v[3])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color3ui(GLuint r, GLuint g, GLuint b)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color3uiv(const GLuint v[3])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color3s(GLshort r, GLshort g, GLshort b)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color3sv(const GLshort v[3])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color3us(GLushort r, GLushort g, GLushort b)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color3usv(const GLushort v[3])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color4ub(GLubyte r, GLubyte g, GLubyte b, GLubyte a)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color4ubv(const GLubyte v[4])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color4b(GLbyte r, GLbyte g, GLbyte b, GLbyte a)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color4bv(const GLbyte v[4])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color4d(GLdouble r, GLdouble g, GLdouble b, GLdouble a)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color4dv(const GLdouble v[4])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color4f(GLfloat r, GLfloat g, GLfloat b, GLfloat a)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color4fv(const GLfloat v[4])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color4i(GLint r, GLint g, GLint b, GLint a)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color4iv(const GLint v[4])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color4ui(GLuint r, GLuint g, GLuint b, GLuint a)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color4uiv(const GLuint v[4])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color4s(GLshort r, GLshort g, GLshort b, GLshort a)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color4sv(const GLshort v[4])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color4us(GLushort r, GLushort g, GLushort b, GLushort a)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Color4usv(const GLushort v[4])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Indexd(GLdouble c)
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Indexf(GLfloat c)
{
    __GL_SETUP();
    __GL_API_VAPI();
    gc->state.current.userColorIndex = c;
...
void GLAPIENTRY __glim_Indexi(GLint c)
{
    __GL_SETUP();
    __GL_API_VAPI();
    gc->state.current.userColorIndex = c;
...
void GLAPIENTRY __glim_Indexs(GLshort c)
{
    __GL_SETUP();
    __GL_API_VAPI();
    gc->state.current.userColorIndex = c;
...
void GLAPIENTRY __glim_Indexub(GLubyte c)
{
    __GL_SETUP();
    __GL_API_VAPI();
    gc->state.current.userColorIndex = c;
...
void GLAPIENTRY __glim_Indexdv(const GLdouble c[1])
{
    __GL_SETUP();
    __GL_API_VAPI();
...
void GLAPIENTRY __glim_Indexfv(const GLfloat c[1])
{
    __GL_SETUP();
    __GL_API_VAPI();
    gc->state.current.userColorIndex = c[0];
...
void GLAPIENTRY __glim_Indexiv(const GLint c[1])
{
    __GL_SETUP();
    __GL_API_VAPI();
    gc->state.current.userColorIndex = c[0];
...
void GLAPIENTRY __glim_Indexsv(const GLshort c[1])
{
    __GL_SETUP();
    __GL_API_VAPI();
    gc->state.current.userColorIndex = c[0];
...
void GLAPIENTRY __glim_Indexubv(const GLubyte c[1])
{
    __GL_SETUP();
    __GL_API_VAPI();
    gc->state.current.userColorIndex = c[0];
