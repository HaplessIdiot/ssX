...
**
** $Date: 2001/02/01 08:29:36 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/vc_cache.c,v 1.1 2001/02/01 08:29:36 alanh Exp $
*/
...
void GLAPIENTRY __glim_VertexCache2fv(const GLfloat v[2])
{
    __GL_SETUP();
    __GLvertex 	*vx;
    __GLvcacheMachine *vc = &gc->vertexCache;
...
void GLAPIENTRY __glim_VertexCache3fv(const GLfloat v[3])
{
    __GL_SETUP();
    __GLvertex 	*vx;
    __GLvcacheMachine *vc = &gc->vertexCache;
...
void GLAPIENTRY __glim_VertexCache4fv(const GLfloat v[4])
{
    __GL_SETUP();
    __GLvertex 	*vx;
    __GLvcacheMachine *vc = &gc->vertexCache;
...
void GLAPIENTRY __glim_VertexCacheBegin(GLenum mode)
{
    __GL_SETUP();
    GLuint beginMode;
...
void GLAPIENTRY __glim_VertexCacheEnd(void)
{
    __GL_SETUP();
    GLuint beginMode;
