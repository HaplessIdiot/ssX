...
**
** $Date: 2001/02/01 08:28:59 $ $Revision: 1.1 $
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/glcore/Attic/s_btdraw.c,v 1.1 2001/02/01 08:28:59 alanh Exp $
*/
#include "render.h"
#include "context.h"
#include "global.h"
