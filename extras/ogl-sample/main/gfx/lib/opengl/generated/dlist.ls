...
# $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/generated/Attic/dlist.ls,v 1.1 2001/02/01 08:28:34 alanh Exp $
...
function output_compile() {
    printf("void GLAPIENTRY __gllc_%s(", functionName);
    outputCArglist();
    printf(")\n");
    printf("{\n");
    if (useVectorEquiv) {
...
function output_compile_SP() {
    printf("void GLAPIENTRY __glsplc_%s(", functionName);
    outputCArglist();
    printf(")\n");
    printf("{\n");
    if (useVectorEquiv) {
...
#        return;
    ...
    printf("%s GLAPIENTRY __glce_%s(", returnType, functionName);
    outputCArglist();
    printf(")\n");
...
function outputHeader_SP() {
    ...
    printf "extern %s GLAPIENTRY %s%s", returnType, "__glsplc_", functionName;
    printf "( ";
    outputCPrototype();
    printf ");\n";
}
