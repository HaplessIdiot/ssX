...
# $Date: 2001/02/01 08:28:35 $ $Revision: 1.1 $
# $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/opengl/generated/Attic/listcomp.ls,v 1.1 2001/02/01 08:28:35 alanh Exp $
...
#		if(array_type ~ "COMPSIZE" || array_type ~ "mapsize")
    ...
    printf("extern void GLAPIENTRY __gllc_%s(", functionName);
    outputCArglist();
    printf(");\n");
...
function finalize()
{
printf("extern void GLAPIENTRY __gllc_UnimplementedExtension(void);\n");
