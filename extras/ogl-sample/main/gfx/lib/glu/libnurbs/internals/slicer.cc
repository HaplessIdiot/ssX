 ...
 * slicer.c++
 *
 * $Date: 2003/10/22 19:20:57 $ $Revision: 1.3 $
 * $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/glu/libnurbs/internals/slicer.cc,v 1.3 2003/10/22 19:20:57 tsi Exp $
 */
