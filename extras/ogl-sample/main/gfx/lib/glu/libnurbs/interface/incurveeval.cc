...
**
** $Date: 2003/10/22 19:20:55 $ $Revision: 1.2 $
*/
/* $XFree86$ */

/*
** $Header: /vol1/history/xf86/xc/extras/ogl-sample/main/gfx/lib/glu/libnurbs/interface/incurveeval.cc,v 1.2 2003/10/22 19:20:55 tsi Exp $
*/
