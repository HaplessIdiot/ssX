 ...
 * trimvertexpool.c++
 *
 * $Date: 2004/04/08 09:16:14 $ $Revision: 1.1 $
 * $Header: /vol1/history/xf86/xc/extras/Mesa/src/glu/sgi/libnurbs/internals/Attic/trimvertpool.cc,v 1.1 2004/04/08 09:16:14 alanh Exp $
 */
