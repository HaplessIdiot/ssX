/* $XFree86: xc/extras/Mesa/src/mesa/glapi/glapitemp.h,v 1.2 2004/04/22 13:58:37 tsi Exp $ */
...
{
   DISPATCH(Clear, (mask), (F, "glClear(%x);\n", mask));
}
...
{
   DISPATCH(PushAttrib, (mask), (F, "glPushAttrib(%x);\n", mask));
}
...
{
   DISPATCH(PushClientAttrib, (mask), (F, "glPushClientAttrib(%x);\n", mask));
}
