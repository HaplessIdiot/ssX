/* $XFree86: xc/programs/Xserver/hw/xfree86/drivers/tseng/tseng_colexp.c,v 1.3.2.1 1998/07/24 11:36:33 dawes Exp $ */
...
/*  if (Is_W32 || Is_W32i) return; */
	...
	/* FIXME! This should be "... && !(Is_W32p && (pTseng->ChipRev == W32REVID_A))" */
	if ((vgaBitsPerPixel == 8)
	    && ((Is_W32p && (pTseng->ChipRev == W32REVID_B)) || Is_W32p_cd)) {
