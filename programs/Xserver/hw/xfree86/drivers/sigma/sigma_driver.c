/* $XFree86: xc/programs/Xserver/hw/xfree86/mono/drivers/sigma/sigmadriv.c,v 3.7 1997/03/04 10:42:15 hohndel Exp $ */
/*
...
#ifdef XFree86LOADER
XF86ModuleVersionInfo sigmaVersRec =
{
	"sigma_drv.o",
	"The XFree86 Project",
	MODINFOSTRING1,
