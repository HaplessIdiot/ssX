/* $XFree86: xc/programs/Xserver/hw/xfree86/drivers/chips/ct_driver.c,v 1.23 1998/06/27 12:54:24 hohndel Exp $ */
/*
	...
	outb(ctCRvalue, (temp & 0x7F) | 0x80);
 	...
 	/* group protection attribute controller access */
	    ...
	    outb(0x3D7, xr15);
            outb(0x3D6, 0x02);
	    temp = inb(0x3D7);
 	    outb(0x3D7, (temp & ~0x18) | xr02);
	    outb(0x3D6, 0x14);
	    temp = inb(0x3D7);
	    outb(0x3D7, (temp & ~0x20) | xr14);
