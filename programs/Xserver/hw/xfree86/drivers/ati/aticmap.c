/* $XFree86: xc/programs/Xserver/hw/xfree86/drivers/ati/aticmap.c,v 1.0tsi Exp $ */
/*
...
ATIStoreColours(ColormapPtr ColourMap, int NumberOfColours, xColorItem *Colour)
{
    ...
    for (Index = 0;  Index < NumberOfColours;  Index++)
    {
        ...
        LUTEntry[0] = Colour[Index].red >> (16 - vga256InfoRec.weight.red);
        LUTEntry[1] = Colour[Index].green >> (16 - vga256InfoRec.weight.green);
        LUTEntry[2] = Colour[Index].blue >> (16 - vga256InfoRec.weight.blue);
