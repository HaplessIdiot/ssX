/* $XFree86: xc/programs/Xserver/hw/xfree86/mono/drivers/hercules/hercules.c,v 3.9 1997/03/04 10:41:18 hohndel Exp $ */
/*
...
#ifdef XFree86LOADER
XF86ModuleVersionInfo herculesVersRec =
{
	"hercules_drv.o",
	"The XFree86 Project",
	MODINFOSTRING1,
    ...
    INT32    * magic;
{
    ...
    case 0:
        * data = (pointer) &herculesVersRec;
        * magic= MAGIC_VERSION;
        break;
    case 1:
      * data = (pointer) &HERCULES;
