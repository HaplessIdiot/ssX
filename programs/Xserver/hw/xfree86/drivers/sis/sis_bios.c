...
static UShort StResInfo[5][2]=
                       {{640,400},{640,350},{720,400},{720,350},{640,480}};
...
#if 0
static UShort NTSCGroup3Data[63]= 
                        {0x000,0x014,0x015,0x025,0x055,0x015,0x00B,0x089,
...
static UShort PALGroup3Data[63]=
                      {0x000,0x01A,0x022,0x063,0x062,0x022,0x008,0x085,
...
static UShort   P3c4,P3d4,P3c0,P3ce,P3c2,P3ca,P3c6,P3c7,P3c8,P3c9,P3da;
      /*VCLKData table length of bytes of each entry*/
static UShort   CRT1VCLKLen;
      /*0: no clear frame buffer 1:clear frame buffer*/
static int      ModeIDOffset,StandTable,CRT1Table,ScreenOffset;
static int     VCLKData;
static int      REFIndex,ModeType;
static UShort   IF_DEF_LVDS;
static UShort   IF_DEF_HiVision;
static UShort   IF_DEF_CH7005;
static UShort   VBInfo, SetFlag,RVBHCFACT,RVBHCMAX,VGAVT,VGAHT;
static UShort   VT,HT,VGAVDE,VGAHDE;
...
void sisDisableBridge(UShort BaseAddr)
{
 ...
 void 
sisDisableBridge301(UShort BaseAddr)  /* TW: needed for external X driver using VESA */
{
...
/*  if(tempah!=0) tempah--; */
  ...
  PDEBUG(xf86DrvMsg(scrnidx, X_PROBED, "SetFlag=0x%x, LCDTypeInfo=%d, "
		    "LCDResInfo=%d, LCDInfo=0x%x\n",
