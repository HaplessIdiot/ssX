...
/*	{0x2e,0x021b,0x0306,0x0101,SIS_RI_640x480,  0x00,0x00,0x05,0x08},    640x480x8 - 650/LVDS BIOS (no CRt2Mode) */
        {0x2f,0x0a1b,0x0305,0x0100,SIS_RI_640x400,  0x00,0x00,0x05,0x10}, /* 640x400x8 */
/*	{0x2f,0x021b,0x0305,0x0100,SIS_RI_640x400,  0x00,0x00,0x05,0x10},    640x400x8 - 650/LVDS BIOS (no CRt2Mode) */
	{0x30,0x2a1b,0x0407,0x0103,SIS_RI_800x600,  0x00,0x00,0x07,0x00}, /* 800x600x8 */
/*	{0x30,0x221b,0x0407,0x0103,SIS_RI_800x600,  0x00,0x00,0x07,0x00},    800x600x8 - 650/LVDS BIOS (no CRt2Mode) */
/*      {0x31,0x0a1b,0x030d,0x0000,SIS_RI_720x480,  0x00,0x00,0x06,0x11},    720x480x8 */
        {0x31,0x0a1b,0x0a0d,0x0000,SIS_RI_720x480,  0x00,0x00,0x06,0x11}, /* 720x480x8 BIOS (301/LVDS) */
	...
	{0x5A,0x021b,0x0014,0x0138,SIS_RI_320x240,  0x00,0x00,0x04,0x3f}, /* 320x480x8 fstn */
	{0x5B,0x0a1d,0x0014,0x0135,SIS_RI_320x240,  0x00,0x00,0x04,0x3f}, /* 320x480x16 fstn */
...
static const SiS310_Ext2Struct SiS310_RefIndex[]=
{
	...
	{0x0827,0x20,0x21,0x09,0x3c,1600,1200}, /* 0x1e */
	...
	{0xc07f,0x01,0x00,0x06,0x5a, 320, 480}, /* 0x3f */    /* FSTN */
