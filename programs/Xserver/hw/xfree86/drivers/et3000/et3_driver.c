/* $XFree86: xc/programs/Xserver/hw/xfree86/vga256/drivers/et3000/et3_driver.c,v 3.24 1997/02/28 08:21:15 hohndel Exp $ */
/*
 *
...
#ifdef USE_PAN
  if (vgaBitsPerPixel < 8) {
    Base = (y * vga256InfoRec.displayWidth + x + 3) >> 4;
    wants_pan = (y * vga256InfoRec.displayWidth + x + 3) & 8;
  } else {
    Base = (y * vga256InfoRec.displayWidth + x + 1) >> 3;
    wants_pan = (y * vga256InfoRec.displayWidth + x + 1) & 4;
  }
#else
  if (vgaBitsPerPixel < 8) 
    Base = (y * vga256InfoRec.displayWidth + x + 7) >> 4;
  else
