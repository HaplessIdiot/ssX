...
#ifdef DEBUG
    fprintf(stderr, "--------------------------------------------------------------------------------\n");
    fprintf(stderr, "RENDITION: Probing for Rendition chipsets ...\n");
#endif 
...
#ifdef DEBUG
            fprintf(stderr, "RENDITION: vendor 0x%x chip 0x%x\n", 
...
#ifdef DEBUG
    fprintf(stderr, "RENDITION: %s found, MEM@0x%x IO@0x%x MMIO@0x%x\n",
        RENDITIONIdent(BOARD.chip==V1000_DEVICE ? 0 : 1), 
        BOARD.mem_base, BOARD.io_base, BOARD.mmio_base);
    fprintf(stderr, "RENDITION: After mapping: MEM@0x%x IO@0x%x MMIO@0x%x\n",
...
{
#ifdef DEBUG
    fprintf(stderr, "RENDITION: RENDITIONLinearOffset() called\n");
#endif
...
{
#ifdef DEBUG
    fprintf(stderr, "RENDITION: RENDITIONFbInit() called\n");
#endif
...
#ifdef DEBUG
    fprintf(stderr, "RENDITION: RENDITIONRestore() called\n");
#endif
...
#ifdef DEBUG
    fprintf(stderr, "RENDITION: RENDITIONSave() called\n");
#endif
...
#ifdef DEBUG
    fprintf(stderr, "RENDITION: RENDITIONEnterLeave(%s) called\n", 
        (enter ? "enter" : "leave"));
#endif
...
#ifdef DEBUG
    fprintf(stderr, "RENDITION: RENDITIONAdjust(%d, %d) called\n", x, y);
#endif
