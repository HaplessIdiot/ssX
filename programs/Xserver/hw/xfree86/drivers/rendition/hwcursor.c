...
{
#ifdef DEBUG
    fprintf(stderr, "RENDITION: RENDITIONHwCursorInit called\n");
#endif

    /* by now the hardware cursor is disabled <ml> */
    XAACursorInfoRec.Flags=0;
    return;
...
{
#ifdef DEBUG
    fprintf(stderr, "RENDITION: ShowCursor called\n");
#endif
...
{
#ifdef DEBUG
    fprintf(stderr, "RENDITION: HideCursor called\n");
#endif
...
{
#ifdef DEBUG
    fprintf(stderr, "RENDITION: SetCursorColors(%x, %x) called\n", fg, bg);
#endif
...
{
#ifdef DEBUG
    fprintf(stderr, "RENDITION: loadcursor called\n");
#endif
