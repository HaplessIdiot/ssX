 ...
 */
/* $XFree86: xc/programs/Xserver/hw/xfree86/drivers/glint/IBMramdac.c,v 1.1.2.2 1998/07/18 17:53:34 dawes Exp $ */
...
unsigned char
glintInIBMRGBIndReg (ScrnInfoPtr pScrn, unsigned char reg)
{
  GLINTPtr pGlint = GLINTPTR(pScrn);
  unsigned char ret;
...
void
glintIBMWriteAddress (ScrnInfoPtr pScrn, unsigned char index)
{
    GLINTPtr pGlint = GLINTPTR(pScrn);
...
void
glintIBMReadAddress (ScrnInfoPtr pScrn, unsigned char index)
{
    GLINTPtr pGlint = GLINTPTR(pScrn);
