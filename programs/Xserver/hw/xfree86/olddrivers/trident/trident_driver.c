/* $XFree86: xc/programs/Xserver/hw/xfree86/drivers/trident/trident_driver.c,v 1.26 1998/01/24 16:58:24 hohndel Exp $ */
/*
...
XF86ModuleVersionInfo tridentVersRec =
{
	"trident_drv.o",
	MODULEVENDORSTRING,
	MODINFOSTRING1,
    	...
    	DisplayModePtr mode;
{
	 ...
	 */
	if ((vga256InfoRec.videoRam < 1024) && (vgaBitsPerPixel >= 8))
	{
		/*
