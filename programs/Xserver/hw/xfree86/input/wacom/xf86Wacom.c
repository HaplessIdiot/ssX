...
/* $XFree86: xc/programs/Xserver/hw/xfree86/input/wacom/xf86Wacom.c,v 1.2 1999/01/14 13:04:51 dawes Exp $ */
		  ...
		  int			buttons)
{
	...
	*/
	...
	/* Turn button index reported by device into a bit mask. */
	buttons = 1 << (buttons - 1);
