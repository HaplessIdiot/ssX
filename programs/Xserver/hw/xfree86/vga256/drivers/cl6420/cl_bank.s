 ...
 *
 *	CL6420SetRead      - Set the read-bank pointer
 *	CL6420SetWrite     - Set the write-bank pointer
 *	CL6420SetReadWrite - Set both bank pointers to the same bank
 *
 * We must convert the 4K banks of the CL6420 into the 32K banks used
 ...
 */
	...
	ALIGNTEXT4
	GLOBL	GLNAME(CL6420SetRead)
GLNAME(CL6420SetRead):
	SHL_L	(CONST(11),EAX)
	...
	ALIGNTEXT4		
	GLOBL	GLNAME(CL6420SetReadWrite)
	GLOBL	GLNAME(CL6420SetWrite)
GLNAME(CL6420SetReadWrite):
GLNAME(CL6420SetWrite):
	SHL_L	(CONST(11),EAX)
