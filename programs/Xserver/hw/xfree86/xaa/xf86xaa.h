...
#define BACKGROUND_OPERATIONS		0x00000001
#define PIXMAP_CACHE			0x00000002
#define COP_FRAMEBUFFER_CONCURRENCY	0x00000004
#define DO_NOT_CACHE_STIPPLES		0x00000008
#define TWO_PASS_24BPP_SOLID_FILL	0x00000010
#define HARDWARE_CLIP_LINE		0x00000020
#define USE_TWO_POINT_LINE		0x00000040
#define TWO_POINT_LINE_NOT_LAST		0x00000080
#define ONLY_TWO_BITBLT_DIRECTIONS	0x00000800
#define ONLY_LEFT_TO_RIGHT_BITBLT	0x00001000
#define NO_SYNC_AFTER_CPU_COLOR_EXPAND  0x00002000
#define TWO_POINT_LINE_ERROR_TERM	0x00004000
#define NO_TEXT_COLOR_EXPANSION		0x00100000
#define HORIZONTAL_TWOPOINTLINE		0x00400000
#define LINE_PATTERN_POWER_OF_2_ONLY	0x00800000
#define LINE_PATTERN_MSBFIRST_MSBJUSTIFIED	0x01000000
#define LINE_PATTERN_MSBFIRST_LSBJUSTIFIED	0x02000000
