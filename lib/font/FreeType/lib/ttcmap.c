 ...
 ******************************************************************/
  ...
  static Int  code_to_index0( UShort  charCode, PCMap0  cmap0 );
  static Int  code_to_index2( UShort  charCode, PCMap2  cmap2 );
  static Int  code_to_index4( UShort  charCode, PCMap4  cmap4 );
  static Int  code_to_index6( UShort  charCode, PCMap6  cmap6 );
 ...
 ******************************************************************/
  ...
  static Int  code_to_index0( UShort  charCode,
                              PCMap0  cmap0 )
  {
    if ( charCode <= 0xFF )
 ...
 ******************************************************************/
  ...
  static Int  code_to_index2( UShort  charCode,
                              PCMap2  cmap2 )
  {
    UShort           index1, idx;
    TCMap2SubHeader  sh2;
 ...
 ******************************************************************/
  ...
  static Int  code_to_index4( UShort  charCode,
                              PCMap4  cmap4 )
  {
 ...
 ******************************************************************/
  ...
  static Int  code_to_index6( UShort  charCode,
                              PCMap6  cmap6 )
  {
    UShort firstCode;
