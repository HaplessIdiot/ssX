 ...
 ******************************************************************/
  ...
  TT_Error  TT_Use_Stream( TT_Stream   input_stream,
                           TT_Stream*  copy )
  {
    return TT_Open_Stream( copy, input_stream->name );
  }
 ...
 ******************************************************************/
  ...
  static  TT_Error  Stream_Activate( PStream_Rec  stream )
  {
    if ( !stream->opened )
    {
      if ( !(stream->file = fopen( stream->name, "rb" )) )
 ...
 *
 *  Output :  lenght of stream in bytes.            
 *
 ******************************************************************/
 ...
 ******************************************************************/
  ...
  unsigned char  TT_Get_Byte( FRAME_ARG )
  {
