                                    ...
                                    PFace       input )
  {
    ...
    for ( n = 0; n < num_pairs; n++ )
    {
      ...
      if ( kern0->pairs[n].left >= input->numGlyphs ||
        ...
        return TT_Err_Invalid_Kerning_Table;
    }
 ...
 ******************************************************************/
  ...
  TT_Error  Kerning_Create( void*  ext,
                            PFace  face )
  {
 ...
 ******************************************************************/
  ...
  TT_Error  Kerning_Destroy( void*  ext,
                             PFace  face )
  {
    TT_Kerning*        kern = (TT_Kerning*)ext;
    TT_Kern_Subtable*  sub;
 ...
 ******************************************************************/
                                      ...
                                      TT_Kerning*  directory )
  {
    ...
    error = Extension_Get( faze, KERNING_ID, (void**)&kerning );
    if ( !error )
      *directory = *kerning;
 ...
 ******************************************************************/
                                   ...
                                   int      kern_index )
  {
    ...
    error = Extension_Get( faze, KERNING_ID, (void**)&kern );
    if ( error )
      return error;
  ...
  TT_Error  TT_Init_Kerning_Extension( TT_Engine  engine )
  {
    ...
    error = Extension_Register( _engine,
                                KERNING_ID,
                                sizeof ( TT_Kerning ),
                                Kerning_Create,
                                Kerning_Destroy );
